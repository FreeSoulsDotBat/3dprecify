          ...
          {filtered.map((item) => {
            ...
            if (result?.stopped) {
              ...
              return (
                ...
                >
                  <Icon name="triangle-alert" size={16} className="text-[var(--warning-text)]" />
                  <div className="flex flex-col gap-0.5">
                    <span className="text-sm">{itemName(item)}</span>
                    <span className="text-xs text-[var(--warning-text)]">
                      {t.stoppedCannotQuote.replace("{data}", formatDayMonthPtBr(dataIso))}
                    </span>
                  </div>
                </Card>
              );
            ...
            return (
              ...
              >
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-0.5">
                  <span className="truncate text-sm font-semibold">{itemName(item)}</span>
                ...
                <span className="tf-tnum text-sm font-semibold">{formatBRL(baseTotal)}</span>
                {isSelected && (
  ...
  return (
    <div className="flex flex-col gap-4">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                <span className="tf-tnum text-sm font-semibold">{formatBRL(subtotal)}</span>
              </div>
      ...
      <Card padding="md" className="flex flex-col gap-3">
        ...
        <BreakdownRow label={t.subtotal} value={quoteResult.grossTotal} data-testid="quote-gross" />
        {discountNum > 0 && (
          <BreakdownRow
            label={
              discountMode === "PCT"
        ...
        {!quoteResult.belowCost && (
          <BreakdownRow
            ...
            sublabel={t.marginOverCostSub.replace("{valor}", formatBRL(quoteResult.costFloor))}
