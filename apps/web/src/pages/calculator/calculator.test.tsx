...
// validation path).
describe("CalculatePage — US1 correct retail + wholesale price", () => {
...
describe("CalculatePage — US2 transparency + validation", () => {
...
describe("CalculatePage — US4 labor + US5 outros custos + US1 marketplace", () => {
...
describe("CalculatePage — US4 'Incluir marketplaces no preço' visibility toggle", () => {
...
describe("CalculatePage — US5 itemized 'Outros custos' slot", () => {
