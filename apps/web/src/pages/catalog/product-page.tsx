...
import { ProductFooter, ProductFormGrid } from "./product-page-body";
import { ProductPriceHeader, productHeaderState } from "./product-page-header";
import { ProductIdentitySection } from "./product-page-identity-section";
