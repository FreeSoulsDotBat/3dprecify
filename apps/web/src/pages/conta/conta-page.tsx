            ...
            <Card className="tf-conta__row tf-conta__row--plan">
                <div className="flex flex-1 flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2">
                        {badge}
                        {caption && (
                            <span style={{ fontSize: "var(--fs-caption)", color: tom }}>
                                {caption}
                            </span>
                        )}
                    </div>
                    {note && (
                        <span style={{ fontSize: "var(--fs-caption)", color: tom }}>{note}</span>
                    )}
                </div>
                    ...
                    options={[
                        {
                            id: "light",
                            label: t.themeLight,
                            icon: <Icon name="sun" size={16} aria-hidden />,
                        },
                        {
                            id: "dark",
                            label: t.themeDark,
                            icon: <Icon name="moon" size={16} aria-hidden />,
                        },
                    ]}
                    value={theme}
                    onChange={(next) => {
