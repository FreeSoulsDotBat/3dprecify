...
import { SnapshotDetailPage } from "@/pages/history/snapshot-detail-page";
...
import { GateChecking, GateError } from "@/pages/history/history-gate-states";
import { HistoryLedger } from "@/pages/history/history-ledger";
import { HistoryMasterDetail } from "@/pages/history/history-master-detail";
import { useHistorySearch } from "@/pages/history/history-search";
import { toLineInput } from "@/pages/history/quote-line-input";
 ...
 * `useFeeCatalog` — a mesma composição de `pages/catalog/catalog-page.tsx` (T124), só que aqui
