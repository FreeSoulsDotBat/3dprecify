...
export const messages = {
    ...
    calculator: {
        ...
        machineCost: {
            ...
            confirmBody:
                '{ritmo} h/ano × {anos}. Seu número volta se você tocar "Ajustar" de novo.',
    ...
    catalogo: {
        ...
        emptyProductsBody:
            "Salve uma peça com seus custos e reabra com o preço sempre recalculado.",
    ...
    scenarios: {
        ...
        listSubtitle:
            "Estratégias salvas. Cada uma recalcula com os preços de hoje quando você abre.",
    ...
    billing: {
        ...
        offerBody:
            "O Premium guarda seu catálogo, kits, orçamentos e simulações — e libera exportar.",
