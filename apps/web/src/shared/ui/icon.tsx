...
const ICONS = {
  ...
  // 019/PR-E (T088, prancheta 18b) — o selo de item escolhido na lista de escolher do catálogo.
  // Glifo do conjunto curado já embarcado em `public/brand/icons/lucide/check.svg` (T002); só
  // faltava entrar no mapa inline. `percent`/`minus`/`user`/`folder` (os outros 4 do "conjunto
  // curado" que a prancheta 18 cita) NÃO estão no bundle curado — não inventados aqui; ver
  // relatório da T088.
  ...
  // 019/PR-E (T088, prancheta 18e) — "Enviar" no diálogo de congelamento. Mesmo bundle curado.
