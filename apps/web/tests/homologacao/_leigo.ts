...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    historia: "Pega os números da etiqueta da impressora e da conta de luz, sem converter unidade.",
    entradas: [
  ...
  },
  {
    ...
    historia: "Digita com ponto no lugar da vírgula e cola valores com R$ e espaços do WhatsApp.",
    entradas: [
