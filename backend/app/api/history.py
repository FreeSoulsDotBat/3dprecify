...
def _validate_declared_discount(payload: dict[str, Any], net_total: decimal.Decimal) -> None:
    ...
    # ⚠ @doc DEC-018 — VERIFICAÇÃO, não recômputo (FR-118 de pé): confere que o abatimento É o
    #   percentual declarado. Vem DEPOIS das três guardas acima para não trocar mensagem de
    #   nenhum documento que já era recusado.
    if mode == "PCT":
