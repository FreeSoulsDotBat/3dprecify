...
// `computeQuote` é função NOVA sobre `computeBom`, e não um parâmetro opcional dele: estender o
// contrato do kit para servir orçamento é como alguém aplica desconto num kit sem querer. Compor na
// tela também estava fora — a FR-1916 proíbe soma paralela, e dois lugares arredondando dinheiro
// divergem num centavo que ninguém vê.
