...
- [ ] T038 Graph refresh after merge to `develop` — **atenção ao caminho real (ADR-0022 §Amendment, corrigido
      ...
      close-out do AI (`pnpm graph:update`) — rode-o, e registre em dod-evidence qual mecanismo disparou de
      fato (hook local vs procedimento manual). O hook novo cobre commits LOCAIS; não espere que ele cubra o
      pull do merge remoto
